                ...
                <div class="card info-card p-3 p-md-4">
                    <div class="card-body">
                        ...
                        <ul class="check-list text-muted mb-0">
                            <li>Товары доставляются с <strong>понедельника по пятницу</strong> (в субботу и воскресенье возможна <strong>Яндекс.Доставка</strong>).</li>
            ...
            <div class="col-12 col-md-6 mb-3 mb-md-4">
                <div class="card info-card p-3 p-md-4 h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted">
                            Вы можете воспользоваться самовывозом из нашего пункта выдачи (<strong>Литературная 22</strong>)
