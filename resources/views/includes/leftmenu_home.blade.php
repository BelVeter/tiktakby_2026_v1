...
<div class="row">
    ...
    -->
    <div class="collapse navbar-collapse left-menu" id="navbar">
        <!-- Пункты вертикального меню -->
        <ul class="navbar-nav nav-top-1">
            @foreach($menu as $m)
                <li class="nav-item level1">
                    <span class="nav-link" style="font-weight: bold; font-size: 1.1rem;" >{{$m->getCatNameText()}}</span>
                </li>
