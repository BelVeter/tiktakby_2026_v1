...
<header>
    <div class="header-top-bar-wrapper d-none d-md-block"
        style="background-color: #f8f9fa; border-bottom: 1px solid #e9ecef;">
        <div class="container-app header-top-bar d-flex justify-content-between align-items-center"
            style="height: 40px; padding: 0 15px;">
            <!-- Left: Navigation Links -->
            <div class="top-bar-left d-flex align-items-center">
                <ul class="top-bar-links d-flex list-unstyled mb-0" style="gap: 20px;">
                    <li><a href="/{{app('request')->lang ? app('request')->lang : 'ru'}}/about"
                            style="text-decoration: none; color: #333; font-family: 'Gilroy'; font-size: 14px;"><span>{{$header->translate('О компании')}}</span></a>
                    </li>
                    <li><a href="/{{app('request')->lang ? app('request')->lang : 'ru'}}/conditions"
                            style="text-decoration: none; color: #333; font-family: 'Gilroy'; font-size: 14px;"><span>{{$header->translate('Условия проката')}}</span></a>
                    </li>
                    <li><a href="/{{app('request')->lang ? app('request')->lang : 'ru'}}/delivery"
                            style="text-decoration: none; color: #333; font-family: 'Gilroy'; font-size: 14px;"><span>{{$header->translate('Доставка и оплата')}}</span></a>
                    </li>
                    <li><a href="/{{app('request')->lang ? app('request')->lang : 'ru'}}/contacts"
                            style="text-decoration: none; color: #333; font-family: 'Gilroy'; font-size: 14px;"><span>{{$header->translate('Контакты')}}</span></a>
                    </li>
                </ul>
            </div>
            <!-- Center: Phone Number -->
            <div class="phone-number-div d-flex flex-row align-items-center">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                        ...
                        stroke="#e30613" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <a class="header-phone" href="#" data-callback
                    style="color: #e30613; font-weight: 400; font-size: 16px; text-decoration: none;">+375 44 745 40
                    40</a>
            </div>
            <!-- Right: Minsk Selector + Social Icons -->
            <div class="top-bar-right d-flex align-items-center" style="gap: 30px;">
                <!-- Minsk Selector -->
                <div class="city-selector d-flex align-items-center">
                    <a class="office_geo-a d-flex align-items-center" href="#" data-bs-toggle="modal"
                        data-bs-target="#officesModal"
                        style="text-decoration: none; color: #333; font-family: 'Gilroy'; font-size: 14px;">
                        <img class="geo" src="/public/svg/geo_logo.svg" alt="geo-logo"
                            style="margin-right: 8px; width: 14px;">
                        <span>Минск, наши салоны</span>
                        <img class="arrow" src="/public/svg/arrow_down.svg" alt="Arrow down"
                            style="margin-left: 8px; width: 10px;">
                    </a>
                </div>

                <!-- Social Icons -->
                <div class="messangers d-flex align-items-center" style="gap: 15px;">
                    <a href="https://t.me/TIKTAK_PROKAT" aria-label="Telegram" target="_blank"
                        class="d-flex align-items-center justify-content-center">
                        <!-- Telegram Outline Icon -->
                        <svg class="social-icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" style="color: #3180D1;">
                            <path d="M22 2L11 13" stroke="currentColor" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M22 2L15 22L11 13L2 9L22 2Z" stroke="currentColor" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </a>
                    ...
                    <a href="https://www.instagram.com/prokat_tiktak.by?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                        aria-label="Instagram" target="_blank" class="d-flex align-items-center justify-content-center">
                        ...
                        <svg class="social-icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path
                                ...
                                stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M17.5 6.5H17.51" stroke="currentColor" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </a>
                </div>
    ...
    <div class="container-app">
        ...
        <div class="row mobile-header-row d-md-none">
            <div class="col mobile-header">
                <button class="menu1-open"><span>{{$header->translate('Еще')}}</span>
    ...
    <div class="header-main-wrapper">
        <div class="header-desktop">
            ...
            <div class="header-col2">
                <div class="header-line1">
                    <form method="post" action="/zvonok" class="back-coll">
                        ...
                        <div class="input-wrapper"><input data-targetinput="" class="call-input1" type="text"
                                name="phone" placeholder="{{$header->translate('Телефон')}}"></div>
                ...
                <div class="header-line2 d-none d-md-flex">
                    ...
                    <div class="header-user-actions d-flex align-items-center gap-3 ms-4" style="flex-shrink: 0;">
                        <a href="#" aria-label="Profile" class="d-flex align-items-center"
                            ...
                            <span class="user-action-label ms-2">Аккаунт</span>
                        </a>
                        <a href="{{ route('favorites.index', ['lang' => request()->lang ?? 'ru']) }}"
                            aria-label="Favorites" class="d-flex align-items-center" style="text-decoration: none;">
                            <div style="position: relative;">
                                ...
                                @if(count(session('favorites', [])) > 0)
                                    <span class="favorites-count">{{ count(session('favorites', [])) }}</span>
                                @else
                                    <span class="favorites-count" style="display: none;">0</span>
                                @endif
                            </div>
                            <span class="user-action-label ms-2">Избранное</span>
                        </a>
                        <a href="#" aria-label="Cart" class="d-flex align-items-center" style="text-decoration: none;">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="user-action-label ms-2">Корзина</span>
                        </a>
                    </div>
            ...
            <div class="header-col4">
                <a class="google-map-pointer d-md-none" href="#" data-bs-toggle="modal"
                    data-bs-target="#officesModal"><img src="/public/svg/map_pointer.svg?v=1"></a>
                <a class="call-back-pointer d-md-none" data-callback="" href="#"><img
                        src="/public/svg/mail_icon.svg?v=1"></a>
                <a class="mobile-phone d-md-none" href="tel:+375447454040" data-mob_phone="1"><img
                        src="/public/svg/phone_top.svg?v=1"></a>
            ...
            @if(is_array($topMenu->getRazdels()) && count($topMenu->getRazdels()) > 0)
                <ul class="mobile-menu-list right" data-navlevel="subrazdel" data-razdelid="{{$r->getIdRazdel()}}">
                    <li class="nav-item-mobile expand back" data-backto="razdel"><img class="arrow-back"
                            src="/public/svg/v_arrow_left.svg"><span class="razdel-text">{{$r->getNameRazdelText()}}</span>
                    </li>
                    @if(is_array($r->getSubRazdels()) && count($r->getSubRazdels()) > 0)
                        @foreach($r->getSubRazdels() as $sr)
                            ...
                            {{-- <li class="nav-item-mobile expand" data-subrazdelid="{{$sr->getIdSubRazdel()}}"><img class="icon"
                                    src="{{$sr->getUrlSubRazdelIcon()}}"><span
                                    class="razdel-text">{{$sr->getNameSubRazdelText()}}</span><img class="arrow"
