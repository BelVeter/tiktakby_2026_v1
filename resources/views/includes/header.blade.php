        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                <div class="modal-header" style="border-bottom: none; padding: 20px 20px 0;">
                    <h5 class="modal-title" id="profileComingSoonModalLabel" style="font-weight: 700; color: #333;">Личный кабинет</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center" style="padding: 20px 30px 30px;">
                    ...
                    <p style="color: #666; font-size: 16px; margin-bottom: 25px;">Мы готовим для вас удобный личный кабинет, где вы сможете:</p>
                    
                    <div style="text-align: left; background: #f8f9fa; padding: 15px; border-radius: 12px; margin-bottom: 25px;">
