    ...
    <div class="container-app footer-container">
        ...
        <div class="row footer-row-1 justify-content-center">
            <div class="col-12 col-sm-6 col-md-4 col footer-logo-col text-center text-md-start">
                <a href="/{{$header->getLang()}}/"><img class="footer-logo-img" src="/public/svg/logo-footer.svg" alt="Tiktak.lt logo"></a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 footer-map-coll d-flex align-items-center justify-content-center justify-content-md-start mt-3 mt-md-0">
                <a href="#" class="footer-map"><img src="/public/svg/footer-map.svg"></img>{{$header->translate('Минск')}}</a>
            </div>
            <form class="col-12 col-sm-6 col-md-4 subscribe-form justify-content-center justify-content-md-start mt-3 mt-md-0" method="post" action="/subscribe">
              @csrf
                <label class="text-center text-md-start" for="subscribe-email">{{$header->translate('Подпишись на наши новости')}}:</label>
        ...
        <div class="row footer-row-2 justify-content-center">
            ...
            <div class="col-12 col-sm-6 col-md-4 footer-col-2 d-flex">
                <ul class="footer-column">
                    <li><a href="/{{app('request')->lang ? app('request')->lang : 'ru'}}/about">{{$header->translate('О компании')}}</a> </li>
                    <li><a href="/{{app('request')->lang ? app('request')->lang : 'ru'}}/conditions">{{$header->translate('Условия проката')}}</a> </li>
                    <li><a href="/{{app('request')->lang ? app('request')->lang : 'ru'}}/delivery">{{$header->translate('Доставка и оплата')}}</a> </li>
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex">
                <ul class="footer-column last">
                    ...
                    <li><a href="/{{app('request')->lang ? app('request')->lang : 'ru'}}/policy">{{$header->translate('Политика обработки персональных данных')}}</a> </li>
                    <li><a href="#">{{$header->translate('Cоглашение на получение рассылки')}}</a> </li>
                </ul>
            </div>
        </div>
        <div class="row footer-row-3 justify-content-center">
            <div class="col-12 col-sm-6 col-md-4">TikTak &copy; {{date("Y")}} {{$header->translate('Все права защищены')}}</div>
            <div class="col-12 col-sm-6 col-md-4 footer-col-2"><span>{{$header->translate('Сервис проката')}}</span></div>
