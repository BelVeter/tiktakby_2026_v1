...
<section class="main-categories">
    <div class="container-app main-categories__container">
        <div class="row row1">
          ...
          <a href="/ru/prokat-sports" class="main-categories__cat-block pic-right" style="background-color: #3277BD;" title="Прокат оборудования для спорта и отдыха">
            <div class="col1">
              <h3>СПОРТ И ОТДЫХ</h3>
        ...
        <div class="row row2">
          <a href="/ru/prokat-detskih-tovarovkarnavalnye-kostyumy" class="main-categories__cat-block pic-left" style="background-color: #FFDE01;" title="Прокат строительного инструмента">
            <div class="col1">
            ...
            <a href="/ru/prokat-detskih-tovarov/begovely_velosipedy_samokaty" class="main-categories__cat-block pic-left" style="background-color: #BFD242;" title="Прокат беговелов, самокатов, велосипедов">
                <div class="col1">
                    <h3>ДЕТСКИЙ ТРАНСПОРТ</h3>
                    <p>велосипеды, самокаты, беговелы, машинки-каталки и др.</p>
                </div>
              <div class="circle"><img class="img" style="width: 95px; bottom: 11px; left: 8px;" src="/public/png/stroy_instrument.png" alt="Прокат беговелов, самокатов, велосипедов"></div>
            </a>
...
<section class="insta-section">
    <div class="container-app conainer-insta">
        ...
        <a href="https://instagram.com/tiktak.by?igshid=YmMyMTA2M2Y=" target="_blank" class="insta_button">ПОДПИШИТЕСЬ</a>
        <a href="https://instagram.com/tiktak.by?igshid=YmMyMTA2M2Y=" target="_blank" class="insta_a_pic">
