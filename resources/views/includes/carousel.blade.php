...
<div class="img-slider">
    ...
    <div class="slide">
        <img src="/public/slider/sleep-bassinet.jpg" alt="" loading="lazy">
        <div class="info">
    ...
    <div class="slide">
        <img src="/public/slider/3.jpg" alt="" loading="lazy">
        <div class="info">
            <h3>транспортные системы</h3>
    ...
    <div class="slide">
        <img src="/public/slider/babybjorn-sl.jpg" alt="" loading="lazy">
        <div class="info">
