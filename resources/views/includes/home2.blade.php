...
@section('page-title', 'Прокат детских товаров Вильнюс')
       ...
       <div class="row">
           <div class="col-12">
               ...
               <p><strong>Выбирая прокат детских товаров TikTak вы получаете:</strong>
                   ...
                   экономию семейного бюджета, быструю доставку по Вильнюсу, официальный договор с гарантией возврата средств при досрочном возврате товара, подробную консультацию при
               ...
               <div class="row">
                   ...
                   <div class="col-md-4" style="background: rgb(236, 236, 230); border-radius: 10px; padding: 25px; margin: 10px; height: 226px; opacity: 1; transform: scale(1);">
                       ...
                       <ul>
                           ...
                           <li style="color: #00b5bd;"><span style="color: #686766;">При наличии регистрации в Вильнюсе залог не требуется.</span></li>
                       </ul>
                   </div>
