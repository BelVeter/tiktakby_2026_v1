...
### Задача 14: Категория — живой поиск + создание через попап

**Files:**
- Create: `bb/category_new_popup.php`
- Modify: `bb/tovar_new_mod.php:557` (заменить `<select>` на виджет, вернуть создание)
- Modify: `bb/classes/Category.php` (`save()` — создавать связь в `subrazdel_category`)
