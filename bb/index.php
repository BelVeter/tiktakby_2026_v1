...
<div class="top_menu">
	...
	<a class="div_item" href="/bb/rash_analysis.php" style="background-color: #00FF00">Анализ расходов.</a>
...
if (User::getCurrentUser()->isOwner()) {
    ...
    <div class="top_menu">
        ...
        <a class="div_item" href="/bb/webp_converter.php" style="background-color: #8F55A6; color: white;">Конвертер WebP</a>
