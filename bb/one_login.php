...
if (!$result_def_of) {die('Сбой при доступе к базе данных: '.$query_def_of.' ('.$mysqli->connect_errno.') '. $mysqli->connect_error);}
...
if (isset($_POST['login'])) {
	...
	if (!$result_lp) {die('Сбой при доступе к базе данных: '.$query_lp.' ('.$mysqli->connect_errno.') '. $mysqli->connect_error);}
