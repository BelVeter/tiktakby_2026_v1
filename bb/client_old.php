...
class client {
    ...
    function getAddressLiv() {
	    return 'г. '.$this->city.', ул.'.$this->str.', д.'.$this->dom.', кв.'.$this->kv;
    }

    function getAddressReg() {
        return 'г. '.$this->reg_city.', ул.'.$this->reg_str.', д.'.$this->reg_dom.', кв.'.$this->reg_kv;
    }
