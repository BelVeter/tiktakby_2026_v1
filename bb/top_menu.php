    ...
    <div class="collapse navbar-collapse bb-top-menu" id="navbarNav">
        <?php if ($_SERVER['PHP_SELF'] != '/bb/index.php'): ?>
            <ul class="navbar-nav mr-auto me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-secondary mr-2" style="background-color: #656d78"
                        href="/bb/dogovor_new.php">Клиенты</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn btn-danger mr-2" style="background-color: #af97eb; border-color: #c9bcf0"
                        href="/bb/kr_baza_new.php">Товары</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link btn btn-info mr-2" style="background-color: #73a9ec" href="/bb/rda.php">Сделки
                        дня</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-success mr-2" style="background-color: #a0d469"
                        href="/bb/kb.php">Карнавал</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link btn btn-warning mr-2 dropdown-toggle" style="background-color: #fccd53" href="#"
                        id="navbarDropdown1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Архив</a>
