...
if (isset($_POST['action'])) {
  switch ($_POST['action']) {
    case 'save':
      ...
      if (isset($_POST['id'])) $np->setId($_POST['id']);
...
?>
  ...
  <div class="container-fluid">
    ...
    <form class="" name="page-form" id="page-form" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col text-center <?= ($p->getId() > 0 ? 'alert-success' : 'alert-warning') ?>"><?= ($p->getId() > 0 ? 'Редактируем существующую страницу.' : 'Создаем новую страницу') ?></div>
      </div>
      <div class="row">
        <label class="col-2 col-form-label" for="title">Title страницы</label>
        <div class="col-4"><input class="form-control" type="text" name="title" id="title" value="<?= $p->getTitle() ?>"></div>
      </div>
      <div class="row">
        <label class="col-2 col-form-label" for="meta_description">Meta description (выдча в поиске гугл)</label>
        <div class="col-4"><input class="form-control" type="text" name="meta_description" id="meta_description" value="<?= $p->getMetaDescription() ?>"></div>
      </div>
      <div class="row mb-3 align-items-end">
        ...
        <div class="col-3">
          ...
          <input name="h1_pic_file" class="form-control" type="file" id="h1pic" accept=".gif,.jpg,.jpeg,.png,.svg,.avif">
        </div>
        <div class="col-1">
      ...
      <div class="row mt-3">
        ...
        <div class="col-4"><input class="form-control" type="text" name="block_2_title" id="block_2_title" value="<?= $p->getBlock2Title() ?>"></div>
      </div>
      <div class="row">
