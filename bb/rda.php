    ...
    <tr>
        ...
        <th style="width:80px;">операция<br />
            <select name="op_type" id="op_type" form="srch_form"
                onchange="document.getElementById('srch_form').submit();" style="width:80px;">
        ...
        <th style="width:90px;"><span title="принял заказ, оплаты и касса, №чека">опл-о</span>
            <select name="payment_type" id="rent_payment_type" form="srch_form"
                onchange="document.getElementById('srch_form').submit();" style="width:50px;">
        ...
        <th style="width:60px;">Офис<br />
            <select name="place" id="place_select" form="srch_form" style="display:inline-block; width:60px"
