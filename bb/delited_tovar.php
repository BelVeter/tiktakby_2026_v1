    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="#" onclick="return false;">Списанный товар<span
...
<div class="row">
    <div class="col">
        <form class="form-inline" method="post" action="delited_tovar.php">
            Товары, списанные в период с <input type="date" name="from" class="form-control" style="margin:5px;"
                value="<? echo $from->format("Y-m-d") ?>"> по <input type="date" name="to" class="form-control"
                style="margin:5px;" value="<? echo $to->format("Y-m-d") ?>">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-center">
                    ...
                    <img class="img-thumbnail rounded" src="/bb/assets/images/avtokreslo_9-36_s.jpg">
