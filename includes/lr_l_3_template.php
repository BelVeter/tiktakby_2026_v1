...
function model_yn_of($id, $office) {
	...
	$free_q1 = "SELECT (item_id) FROM tovar_rent_items WHERE model_id='$id' AND (`status`='to_rent' OR (`status`='t_bron' AND br_time<".time().")) AND item_place='$office' AND `state`=3 LIMIT 1";
...
function new_old_pr () {
	if (document.getElementById('new_pr').style.display=="none") {
		document.getElementById('new_pr').style.display="";
		document.getElementById('old_pr').style.display="none";
	}
	else {
		document.getElementById('new_pr').style.display="none";
		document.getElementById('old_pr').style.display="";
	}
}
...
function br_office (model_id) {
	...
	if (document.getElementById('br_of_radio_3')) {
		if (document.getElementById('br_of_radio_3').checked!=true) {
			ch3=0;
		}
		else {
			ch3=1;
	...
	if (valid==false) {
		...
		else if (document.getElementById('br_of_radio_3') && document.getElementById('br_of_radio_3').checked==true) {
			br_office=3;
		}
		else {
			br_office=0;
		...
		item_3_id=document.getElementById('item_3_id').value;
		...
		var params = 'q_type=' + encodeURIComponent(q_type) + '&model_id=' + encodeURIComponent(model_id) + '&br_office=' + encodeURIComponent(br_office) + '&fio=' + encodeURIComponent(fio) + '&tel=' + encodeURIComponent(tel) + '&dop_info=' + encodeURIComponent(dop_info) + '&item_1_id=' + encodeURIComponent(item_1_id) + '&item_2_id=' + encodeURIComponent(item_2_id) + '&item_3_id=' + encodeURIComponent(item_3_id) + '&br_time=' + encodeURIComponent(br_time) + '&deliv_addr=' + encodeURIComponent(deliv_addr) + '&br_sposob=' + encodeURIComponent(br_sposob);
...
function br_zayav (model_id) {
	...
	if (valid==false) {
		...
		var params = 'q_type=' + encodeURIComponent(q_type) + '&model_id=' + encodeURIComponent(model_id) + '&zayav_tenor=' + encodeURIComponent(zayav_tenor) + '&fio=' + encodeURIComponent(fio) + '&tel=' + encodeURIComponent(tel) + '&dop_info=' + encodeURIComponent(dop_info);
...
function br_cans () {
		...
		var params = 'q_type=' + encodeURIComponent(q_type) + '&item_1_id=' + encodeURIComponent(item_1_id) + '&item_2_id=' + encodeURIComponent(item_2_id) + '&item_3_id=' + encodeURIComponent(item_3_id) + '&br_time=' + encodeURIComponent(br_time);
...
<!--Хлебные крошки-->
<span style="font-family: verdana, sens-serif; font-size: 12px; color: #00a0d0; font-style: italic;">
    <a href="/">Главная</a> <img src="/images/ar.png"> <a href="/prokat/last_rent/last_rent.htm"> Последний прокат</a> <img src="/images/ar.png"> <?php echo $m_i['item_name_main']; ?>
</span>
...
<div id="dm_box">
   <div id="box_left"><a class="first" title="<?php echo $m_i['m_a_title']; ?>" href="<?php echo $lr->getMainPhotoUrl(); ?>"><img style="height: 350px;" src="<?php echo $lr->getMainPhotoUrl(); ?>" alt="<?php echo $m_i['m_pic_alt']; ?>"></a></div>
 
<div id="box_right_new">
		<div class="dima_1"><img src="<?php echo $m_i['logo']; ?>" /></div>
     
<table class="tarifs_table_new" style="padding: 10px 0; margin-top: 40px;">
	<tr class="t_h_r">
    	<td class="t_h_last_rent" style="font-size: 20px;">Цена выкупа:</td>
    </tr>
<?php

$tar_line=0;
$old_prices='';
echo '<tbody id="new_pr">';

	echo '
	<tr>
		<td class="t_d_last_rent" style="font-size: 16px;"> '.number_format($lr->sale_price, 0, ',', ' ').' бел.руб.</td>    
    </tr>	
			';
...
$theof3=model_yn_of($model_id, '3');

if ($theof1=='notavailable_line.png' && $theof2=='notavailable_line.png' && $theof3=='notavailable_line.png') {
...
<a href="#" class="small_line_1" onclick="addr_a_show('addr_1'); return false;" onmouseenter="addr_show('addr_1'); return false;" onmouseleave="addr_hide('addr_1'); return false;">Адрес пункта проката №1:<br /><strong>ул. Литературная 22</strong><img class="yesnoline" src="/images/<?php echo $theof1; ?>" /><img class="arrow_d" src="/images/arrow_down.png" /></a>
...
<a href="#" class="small_line_3" onclick="addr_a_show('addr_3'); return false;" onmouseenter="addr_show('addr_3'); return false;" onmouseleave="addr_hide('addr_3'); return false;">Адрес пункта проката №3:<br /><strong>пр-т. Победителей 125</strong><img class="yesnoline" src="/images/<?php echo $theof3; ?>" /><img class="arrow_d" src="/images/arrow_down.png" /></a>
<a href="" class="small_line_4" onclick="addr_a_show('addr_4'); return false;" onmouseenter="addr_show('addr_4'); return false;" onmouseleave="addr_hide('addr_3'); return false;">Адрес пункта проката №4:<br /><strong>ждем Ваши пожелания :)</strong><!--<img class="yesnoline" src="/images/<?php echo $theof3; ?>" /><img class="arrow_d" src="/images/arrow_down.png" /> --></a>
...
<div class="addr_w_hours">
	...
	<table border="0">
		<tr class="addr_t_row">
			...
			<td>10<sup>00</sup> - 19<sup>00</sup></td>
		</tr>
		<tr class="addr_t_row">
			<td>Сб, Вс:</td>
...
<div class="addr_3" id="addr_3">
<input type="button" class="addr_close" value="X" onclick="addr_a_show('addr_3'); return false;" />
<div class="addr_w_hours">
	<strong><u>&nbspЧасы работы:</u></strong><br /><br /><input type="hidden" id="addr_3_a_show" value="0" />
	<table border="0">
		<tr class="addr_t_row">
			<td style="width:65px;">Пн-пт:</td>
			<td>10<sup>00</sup> - 19<sup>00</sup></td>
...
<?php
if ($lr->getDopPhotoNum()>0) {
	echo '<div id="box_left_1" style="overflow: hidden">
       <br/>
		';	

	foreach ($lr->getDopPhotoUrlArray() as $a) {
        echo '
		<a class="two" rel="group" title="" href="'.$a.'"><img style="height: 120px;" src="'.$a.'" alt="" /></a>
				';
    }
//	while ($dop_p=$result_dop_p->fetch_assoc()) {
//		echo '
//		<a class="two" rel="group" title="" href="'.$dop_p['big'].'"><img src="" alt="" /></a>
//				';
//	}
...
<blockquote><?php echo '<strong>ПРИЧИНА ВЫБЫТИЯ:</strong><br>'.$lr->dop_info; ?></blockquote>
