...
//	}
	...
	echo '<strong><i>Вариант №'.$free_items_count.'</i></strong>(место выдачи костюма:'.(($items['item_place']=='1' || $items['item_place']=='3') ? ' ул. Литературная 22' : ' ул. Литературная 22').')<br />';
...
<p>Забрать костюм из салона проката можно не ранее <br /><strong>'.date("H", $t_from).'</strong><sup>00</sup><strong>'.date(" d ", $t_from).$r_months[date("m", $t_from)].date(" Y", $t_from).'г.</strong> по адресу:<br /></p><p class="karn_br_addr">'.(($item['item_place']=='1' || $item['item_place']=='3') ? ' ул. Литературная 22' : ' ул. Литературная 22').'</p>
