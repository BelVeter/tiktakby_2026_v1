...
function model_yn_of($id, $office) {
	...
	$free_q1 = "SELECT (item_id) FROM tovar_rent_items WHERE model_id='$id' AND `state`!=3 AND (`status`='to_rent' OR (`status`='t_bron' AND br_time<".time().")) AND item_place='$office' LIMIT 1";
