...
| Rental | `rent_deals_act`, `rent_orders`, `rent_model_web` (includes `faq_json`), `rent_tarif_act`, `rent_sub_deals_act`, `deals` |
...
| Content | `pages` (includes `faq_json`), `video_links`, `dop_photos` |
